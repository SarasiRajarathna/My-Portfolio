...
function Hero() {
  return (
    <div id='Home' className='relative flex items-center flex-col gap-9 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800'>
        <img src={profile_img} alt="Profile" className='mt-32 w-64 h-64 md:w-75 md:h-75 lg:w-90 lg:h-90 rounded-full object-cover shadow-2xl border-4 border-transparent bg-gradient-to-r from-fuchsia-600 to-yellow-600 hover:scale-105 transition-transform duration-300'/>
        ...
        <div className='flex items-center gap-5 text-xl font-medium mb-8'>
